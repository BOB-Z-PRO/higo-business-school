...
const fiveBans = [
  { id: 1, title: '禁止夸大产品效果', desc: '不得声称产品能治愈疾病或保证特定效果，因人而异' },
  { id: 2, title: '禁止虚假宣传', desc: '不得伪造资质、案例、数据，一经发现取消经营权' },
  { id: 3, title: '禁止疾病治疗承诺', desc: '产品为食品保健品，不能宣传任何疾病治疗效果' },
  { id: 4, title: '禁止收益保证承诺', desc: '绝对禁止承诺任何收益，禁止暗示人人必赚' },
...
const productGuidelines = [
  ...
  { forbidden: '保证吃了产品能达到什么效果', forbiddenIcon: XCircle },
...
const complianceQA = [
  { q: '可以说"吃了AKG头发变黑了"吗？', a: '可以说分享自己的真实体验"我吃AKG一段时间后头发变黑了"，但要注明"因人而异"，不能保证别人吃了也有同样效果。' },
  ...
  { q: '早会内容可以转发到朋友圈吗？', a: '可以转发公司统一提供的早会内容，但禁止添加任何收益承诺或疾病治疗描述。转发前请检查是否有"保证"、"一定"等绝对化用语。' },
  { q: '可以在群里发红包奖励业绩吗？', a: '可以有小额奖励行为，但禁止以"保证赚钱"、"稳赚"等名义发红包。红包奖励应是庆祝小胜利，而非承诺收益。' },
