export const businessSpaces = [
  {
    ...
    level: '新人 → 三星 SVIP',
    description:
      '从不了解到愿意学习、愿意自用、愿意分享，先把基础认知和标准动作做扎实。',
    goals: ['认识公司', '认识产品', '理解模式', '完成自用', '开始分享', '借力会议'],
    features: [
      { icon: '📚', title: '该学什么', desc: '聚焦公司基础、产品基础和表达基础。' },
      { icon: '🎤', title: '该会什么', desc: '能用简洁语言讲清 HIGO 是什么、产品能支持什么。' },
  ...
  },
  {
    ...
    level: '一星 → 三星钻石',
    description:
      '从自己会分享到能够带动新人，逐步建立稳定学习、会议借力和团队氛围。',
    goals: ['稳定分享', '建立成交力', '带动新人', '形成共学氛围', '理解会议系统'],
    features: [
  ...
  },
  {
    ...
    level: '一星 → 三星黑钻',
    description:
      '把个人动作升级为团队系统，逐步建立复制、会议、讲师与文化机制。',
