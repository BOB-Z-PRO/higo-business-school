...
export const sevenDayTasks: SevenDayTask[] = [
  {
    ...
    lesson: { title: '新人第一天：定位与边界', duration: '12 分钟', href: '/courses/newcomer-positioning' },
  ...
  },
  {
    ...
    lesson: { title: '体验式分享模板', duration: '15 分钟', href: '/courses/product-experience' },
  ...
  },
  {
    ...
    lesson: { title: '轻邀约三步法', duration: '18 分钟', href: '/courses/light-invite' },
  ...
  },
  {
    ...
    lesson: { title: '会议前中后话术', duration: '20 分钟', href: '/courses/meeting-support' },
  ...
  },
  {
    ...
    lesson: { title: '高频异议回应', duration: '16 分钟', href: '/courses/objection-handling' },
  ...
  },
  {
    ...
    lesson: { title: '内容资产化方法', duration: '14 分钟', href: '/courses/content-ops' },
  ...
  },
  {
    ...
    lesson: { title: '首周复盘模板', duration: '22 分钟', href: '/courses/week-review' },
